...
export const relationships = sqliteTable("relationships", {
  ...
  uniqueIndex("idx_relationships_unique").on(table.sourceType, table.sourceId, table.targetType, table.targetId, table.relationship),
]);

export const decisionLinks = sqliteTable("decision_links", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  decisionId: integer("decision_id").notNull().references(() => decisions.id, { onDelete: "cascade" }),
  linkedDecisionId: integer("linked_decision_id").notNull().references(() => decisions.id, { onDelete: "cascade" }),
...
export const modeTransitions = sqliteTable("mode_transitions", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
...
export const serviceDeps = sqliteTable("service_deps", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const infraEvents = sqliteTable("infra_events", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const secretsRegistry = sqliteTable("secrets_registry", {
  ...
  index("idx_secrets_service").on(table.serviceId),
]);
...
export const dependencyVulnerabilities = sqliteTable("dependency_vulnerabilities", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
  ...
  index("idx_dep_vuln_project").on(table.projectId),
]);
...
export const performanceFindings = sqliteTable("performance_findings", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
  filePath: text("file_path").notNull(),
  findingType: text("finding_type").notNull(),
  ...
  index("idx_perf_findings_project").on(table.projectId),
]);
...
export const focus = sqliteTable("focus", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
  sessionId: integer("session_id").references(() => sessions.id, { onDelete: "cascade" }),
...
export const blastRadius = sqliteTable("blast_radius", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
...
export const blastSummary = sqliteTable("blast_summary", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
  filePath: text("file_path").notNull(),
