/**
 * Context Bundle
 * Core prediction logic: assembles all relevant context for a task.
 */

import type { DatabaseAdapter } from "../../database/adapter.js";
import type { PredictionBundle } from "../../types.js";
import { getTopProfileEntries } from "../profile.js";
import { getCorrelatedFiles } from "../session.js";
...
export async function predictContext(
  ...
  // Advisory is imported lazily to avoid circular deps
  const { generateAdvisory } = await import("./advisory.js");
